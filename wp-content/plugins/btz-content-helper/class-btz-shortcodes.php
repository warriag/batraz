...
if (!class_exists('Btz_Shortcodes')) {
    ...
    class Btz_Shortcodes {
        ...
        function __construct() {
            ...
            require_once 'library/class-btz-content-queries.php';
        ...
        function json_query_post() {
            ...
            if (isset($_POST['tiny_request'])) {
                ...
                switch ($request) {
                    case 'taxonomies':
                        echo json_encode(Btz_Content_Queries::get_taxonomies_with_ids());
                        break;
                    case 'post_list':
                        if (isset($_POST['pageNum'])) {
                            echo json_encode(Btz_Content_Queries::get_post_titles_ids_paged($_POST['pageNum']));
                        }
                        break;
                }
            }
